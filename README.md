...
- **Automated Updates**: Daily checks for new Alist releases.
- **Docker Integration**: Optimized for iKuai's Docker environment.
- **Auto-Config**: Initializes admin password to `123456` if configuration is missing.
...
- **Default URL**: `http://<Router-IP>:5244`
- **Default User**: `admin`
- **Default Password**: `123456` (Change immediately after login!)

## 🔗 Links

- [Official Alist Repository](https://github.com/AlistGo/alist)
